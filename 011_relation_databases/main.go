...
func main() {
	db, err = sql.Open("mysql", "root:password@tcp(localhost:3306)/dbname?charset=utf8")
	check(err)
	defer db.Close()
	...
	http.HandleFunc("/costumers", costumers)
...
func costumers(w http.ResponseWriter, req *http.Request) {
